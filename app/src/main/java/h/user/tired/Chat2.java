...
//        activity_main2 = (RelativeLayout)findViewById(R.id.chat2a);
...
//                Snackbar.make(activity_main2,FirebaseAuth.getInstance().getCurrentUser().getEmail().toString(),Snackbar.LENGTH_SHORT).show();
//                FirebaseDatabase.getInstance().getReference().child("messages").child("").push().setValue(new ChatMessage(input.getText().toString(),FirebaseAuth.getInstance().getCurrentUser().getEmail()));
//                input.setText("");
//
//            }
//        });
...
//
//        adapter = new FirebaseListAdapter<ChatMessage>(this,ChatMessage.class,R.layout.list_item,re)
//        {
//            @Override
